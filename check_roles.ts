...
async function main() {
  ...
  // 2. Ejecuta en la base de datos de producción el UPDATE para que el registro del usuario apexdigital70@gmail.com tenga el rol y role_id correspondiente a DIRECTOR
