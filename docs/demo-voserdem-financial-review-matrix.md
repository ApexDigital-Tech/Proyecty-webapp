...
| **9** | **Datos del Proveedor** | **Parcial** | Almacenado en `title` y metadatos con `NIT DEMO — NO VÁLIDO` | `[CP]` | Requiere tabla de proveedores | `MEDIA` | Definir si se requiere catálogo maestro de proveedores / NIT. |
...
| **14** | **Tratamiento Tributario (Retenciones)**| **Pendiente de Validación**| Tratamiento tributario sujeto a validación por la Administradora de VOSERDEM y asesoría contable conforme a la normativa vigente | `[NC]` | Validar con Administradora | `MEDIA` | **Brecha P2:** Retenciones se aplican en libros oficiales. |
...
| **30** | **Alineación Normativa Donantes** | **Parcial** | Soporte de trazabilidad y elegibilidad de gastos | `[CP]` | Cumplimiento donantes | `ALTA` | Adecuación a guías financieras de cooperación internacional. |
...
7. **¿Qué esquema de retenciones tributarias debe considerarse para los reportes de rendición?**
   *Opciones:* (A) Tratamiento tributario sujeto a validación por la Administradora de VOSERDEM y asesoría contable conforme a la normativa vigente; (B) No aplicar retenciones en plataforma (solo montos netos pagados).
...
10. **¿VOSERDEM reporta a una casa matriz, financiador u otra entidad que exija un formato financiero específico?**
    *Opciones:* (A) Informes periódicos por partida y donante conforme a normativa vigente; (B) Formatos personalizados según términos de referencia del convenio.
